...
spark = SparkSession.builder.appName("PassingIncremental").getOrCreate()

raw_path = "hdfs://ip-172-31-3-80.eu-west-2.compute.internal:8020/tmp/DE011025/Joe/raw/nfl_passing/"
silver_path = "hdfs://ip-172-31-3-80.eu-west-2.compute.internal:8020/tmp/DE011025/Joe/silver/nfl_passing_output/"
...
num_cols = ["attempts","completions","yards","tds","interceptions"]
for c in num_cols:
